...
* **Member Portal (Private)**:
  ...
  - Skills & Endorsements, Endorsement Inbox — *Phase 1 prototyped equivalent of the trust-building surface above; see `10_VERIFICATION_MODEL.md` §1A for the reconciliation between the two*
* **Mentor Portal**:
